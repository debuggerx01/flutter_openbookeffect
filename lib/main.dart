              ...
              children: [
                ...
                return new GestureDetector(
                  onTap: () {
                      ...
                      new Positioned.fromRect(
                        ...
                        child: new AnimatedBuilder(
                          ...
                          builder: (BuildContext context, Widget child) {
                            var offset = OpenBookEffect
                                .getOffsetFromCentrePoint(
                                context, rect);
                            ...
                            double scaleRatio = openAniController.value *
                                ...
                                OpenBookEffect
                                    .getMaxScaleRadio(context, rect)
                                    .minRadio;

                            var translateMatrix4 = new Matrix4.identity()
                              ..translate(offset.dx, offset.dy);

                            var scaleMatrix4 = new Matrix4.identity()
                              ..scale(1 + scaleRatio);
                            ...
                            return new Stack(
                              children: <Widget>[
                                new Transform(
                                  ...
                                  child: new Transform(
                                    origin:
                                    new Offset(rect.width / 2, rect.height / 2),
                                ...
                                new Transform(
                                  origin: new Offset(
                                      offset.dx - (rect.width * scaleRatio / 2),
                    ...
                    Rect fillRect =
                    OpenBookEffect.getRectOfRectWithMoveToCenterAndScaled(
                        context,
                        rect,
                        SV.openBookScaleRadioKey *
                            OpenBookEffect
                    ...
                    var scaleRadio = OpenBookEffect.getMaxScaleRadio(
                        context, fillRect);
                        ...
                        child: new AnimatedBuilder(
                          ...
                          builder: (BuildContext context, Widget child) {
                            var fillMatrix4 = new Matrix4.identity()
                              ..scale(
                                  1 + scaleRadio.w * fillAniController.value,
